...
>>>>>>> 665e7085178e0a750f25ed56412461830fb028b0
...
`r table("2012--present", "I have refereed papers for the following journals: Ciência Rural, Spatial Statistics, Floresta & Ambiente, Earth System Science Data, Revista Brasileira de Ciência do Solo, Geoderma, Soil Science Society of America Journal, Scientia Agricola, Archives of Agronomy and Soil Science.")`
...
`r table(2019, "<b>SAMUEL-ROSA, Alessandro</b>; BRUS, D. J.; HEUVELINK, G. B.; VASQUES, G. M.; ANJOS, L. H. C. Optimization of sample configurations for spatial trend estimation for soil mapping. European Journal of Soil Science (IN PREPARATION).", "https://www.researchgate.net/project/Optimization-of-sample-configurations-for-spatial-trend-estimation-for-soil-mapping")`

`r table(2019, "COSTA, E. M.; <b>SAMUEL-ROSA, Alessandro</b>; ANJOS, L. H. C. Choosing a digital elevation model for digital soil mapping. Annals of the Brazilian Academy of Sciences. Revista Brasileira de Ciência do Solo (IN PREPARATION).", "https://www.researchgate.net/project/Choosing-a-digital-elevation-model-for-digital-soil-mapping")`

`r table(2019, "CEDDIA, M. B.; VILLELA, A. L. O.; VASQUES, G. M.; <b>SAMUEL-ROSA, Alessandro</b>. Digital soil mapping in the poorly-accessible Brazilian Amazon using a reference area. Science of the Total Environment (IN PREPARATION).", "https://www.researchgate.net/project/Digital-soil-mapping-in-the-Brazilian-Amazon--using-the-knowledge-from-a-reference-area")`

`r table(2018, "ALHO, C. F. B. V.; <b>SAMUEL-ROSA, Alessandro</b>; HIEMSTRA, T.; KUYPER, T. W.; MARTINS, G. C.; TEIXEIRA, W. G. Spatial variation of carbon and nutrients stocks in Amazonian Dark Earths. Geoderma (ACCEPTED WITH MINOR REVISION)", "https://www.researchgate.net/project/Spatial-modelling-of-elemental-stocks-in-Amazonian-Dark-Earths")`
...
`r table(2013, "<b>SAMUEL-ROSA, Alessandro</b>; DALMOLIN, R. S. D.; MIGUEL, P. Building predictive models of soil particle-size distribution. Brazilian Journal of Soil Science, v. 37, p. 422-430.", doi = "10.1590/s0100-06832013000200013")`

`r table(2013, "<b>SAMUEL-ROSA, Alessandro</b>; DALMOLIN, R. S. D.; MIGUEL, P.; ZALAMENA, J.; DICK, D. P. The effect of intrinsic soil properties on soil quality assessments. Brazilian Journal of Soil Science, v. 37, p. 1236-1244.", doi = "10.1590/s0100-06832013000500013")`

`r table(2012, "PEDRON, F. A.; <b>SAMUEL-ROSA, Alessandro</b>; DALMOLIN, R. S. D. Variation in pedological characteristics and the taxonomic classification of Argissolos (Ultisols and Alfisols) derived from sedimentary rocks. Brazilian Journal of Soil Science, v. 36, p. 1-9.", doi = "10.1590/S0100-06832012000100001")`

`r table(2011, "<b>SAMUEL-ROSA, Alessandro</b>; DALMOLIN, R. S. D.; PEDRON, F. A. Characterization of soil covers in closed landfill sites with (geo)statistical tools. Engenharia Sanitária e Ambiental, v. 16, p. 121-126.", "http://www.scielo.br/scielo.php?script=sci_arttext&pid=S1413-41522011000200004&lng=en&tlng=pt")`
